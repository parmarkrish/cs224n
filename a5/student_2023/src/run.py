...
if args.function == 'pretrain':
    ...
    trainer_ = trainer.Trainer(gpt, pretrain_dataset, None, tconf)
    trainer_.train()
    ...
    if args.reading_params_path is None:
        ...
        max_epochs = 10
        gpt.load_state_dict(args.reading_params_path)
    ...
    trainer_ = trainer.Trainer(gpt, finetune_dataset, None, tconf)
    trainer_.train()
