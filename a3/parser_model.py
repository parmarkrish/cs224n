...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.hidden_to_logits_weights = nn.Parameter(nn.init.xavier_uniform_(torch.empty(hidden_size, n_classes)))
    ...
    def forward(self, w):
        ...
        h = self.dropout(h)
        logits = h.mm(self.hidden_to_logits_weights) + self.hidden_to_logits_bias
